...
function love.draw()
    ...
    drawRightArm(leg1.mode,leg1.x,leg1.y,leg1.width,leg1.height,leg1.theta)
    drawLeftArm(arm2.mode,leg2.x,leg2.y,leg2.width,leg2.height,leg2.theta)
    drawRotatedImage(cat, catObj.x, catObj.y, catObj.theta, headWidth)
    drawRotatedImage(tie, 100, 100, tieTheta, 10)
